...
import blackWidow from "./Components/black widow.jpg";
import darkCrimes from "./Components/dark crimes.jpg";
import dora from "./Components/dora.jpg";
import ema from "./Components/ema.jpg";
import papillon from "./Components/papillon.jpg";
import splice from "./Components/splice.jpg";
import timeOut from "./Components/time out.jpg";
import tunisianHorror from "./Components/tunisian horror.jpg";
import theinvisibleman from "./Components/theinvisibleman.jpg";
import mulan from "./Components/mulan.jpg";
import dachra from "./Components/dachra.jpg";
...
function App() {
  const [movies, setMovies]=useState(
    ...
    {name:"The invisible man", date:2020, image:theinvisibleman, rate:5, link:"#"},
    {name:"Mulan", date:2020, image:mulan, rate:3, link:"#"},
    {name:"Dachra", date:2019, image:dachra, rate:2, link:"#"}
    ]
)
